document.addEventListener('DOMContentLoaded', function () {
  ...
  var META_PIXEL_ID = '1600523948405792';
  ...
  function applyConsent(consent) {
    ...
    if (consent.marketing && !window.fbPixelLoaded) {
      ...
      // Kein <noscript>-Fallback nötig: ohne JavaScript funktioniert der
      // Cookie-Banner selbst nicht, also kann ohnehin keine Einwilligung erfolgen.
    }
  }
